...
fold = 0
name = '220127_baseline+cvfold{:d}_longformer'.format(fold)
...
conf = dict(
    ...
    NERLoadModel=dict(
        ...
        model_name='model',
        seed=42,
        #saved_model='storage/output/220127_baseline+cvfold0_longformer/NERTrain/allenai-longformer-base-4096_valscore0.62342_ep9.pt',
        ),
    ...
    NERPredictionString=dict(
        dataloader='val_loader',
        probs_name='probs',
        #probs_name='storage/output/220127_baseline+cvfold0_longformer/NERInfer/probs.npy',
        proba_thresh = {
            "Lead": 0.7,
            "Position": 0.55,
            "Evidence": 0.65,
