...
fold = 1
name = '220128_baseline+lstm_cvfold{:d}_longformer-large'.format(fold)
...
conf = dict(
    ...
    NERLoadModel=dict(
        ...
        args=dict(
            ...
            ner_model_weight='storage/output/220128_baseline+cvfold1_longformer-large/NERTrain/allenai-longformer-large-4096_valscore0.66656_ep4.pt',
            ner_model_args=dict(
                bert_model='allenai/longformer-large-4096',
                num_labels=15,
                freeze_bert=False,
