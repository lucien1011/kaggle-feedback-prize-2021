...
conf = dict(
    ...
    NERPrepareData=dict(
        ...
        train_samples_path='storage/output/220126_baseline_preprocess_bi_mskfold_bigbird/NERPreprocessKFold/train_samples_fold{:d}.p'.format(fold),
        valid_samples_path='storage/output/220126_baseline_preprocess_bi_mskfold_bigbird/NERPreprocessKFold/valid_samples_fold{:d}.p'.format(fold),
