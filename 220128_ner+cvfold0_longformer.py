...
fold = 0
name = '220128_ner+cvfold{:d}_longformer'.format(fold)
...
conf = dict(
    ...
    NERLoadModel=dict(
        ...
        bert_model="allenai/longformer-base-4096",
        model_name='model',
        saved_model='storage/output/220128_ner+cvfold0_longformer/NERTrain/allenai-longformer-base-4096_valscore0.52269_ep3.pt',
        ),
    ...
    NERPredictionString=dict(
        pred_df_name='storage/output/220128_ner+cvfold0_longformer/NERInfer/pred_df.csv',
