...
fold = 0
name = '220203_baseline+stance+lstm_cvfold{:d}_longformer-large'.format(fold)
...
conf = dict(
    ...
    NERLoadModel=dict(
        ...
        args=dict(
            ...
            ner_model_weight='storage/output/220128_baseline+cvfold0_longformer-large/NERTrain/allenai-longformer-large-4096_valscore0.65187_ep5.pt',
            ner_model_args=dict(
            ...
            stance_model_type='',
            stance_model_weight='storage/output/220202_stance_cvfold0_longformer/NERTrain/allenai-longformer-base-4096_valscore0.34105_ep1.pt',
