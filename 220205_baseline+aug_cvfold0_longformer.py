...
fold = 0
name = '220205_baseline+aug_cvfold{:d}_longformer'.format(fold)
...
conf = dict(
    ...
    NERPrepareData=dict(
        ...
        train_samples_path='storage/output/220205_baseline+aug_preprocess_bi_mskfold/NERPreprocessKFold/all_train_samples_fold{:d}.p'.format(fold),
    ...
    NERLoadModel=dict(
        ...
        model_name='model',
        seed=42,
        saved_model='storage/output/220205_baseline+aug_cvfold0_longformer/NERTrain/allenai-longformer-base-4096_valscore0.63386_ep9.pt',
        ),
