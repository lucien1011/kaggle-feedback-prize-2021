...
fold = 0
name = '220205_tokenclassification_cvfold{:d}_longformer'.format(fold)
...
conf = dict(
    ...
    NERPrepareData=dict(
        ...
        train_samples_path='storage/output/220205_tokenclassification_preprocess_mskfold/NERPreprocessKFold/train_samples_fold{:d}.p'.format(fold),
        valid_samples_path='storage/output/220205_tokenclassification_preprocess_mskfold/NERPreprocessKFold/valid_samples_fold{:d}.p'.format(fold),
...
pipelines = [
        ...
        ('NERTrain',mod.Train()),
        ('NERInfer',mod.Infer()),
        ('NERPredictionString',mod.PredictionString()),
        ('NEREvaluateScore',mod.EvaluateScore()),
