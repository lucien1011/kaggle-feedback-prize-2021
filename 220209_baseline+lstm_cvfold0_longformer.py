...
fold = 0
name = '220209_baseline+lstm_cvfold{:d}_longformer'.format(fold)
...
conf = dict(
    ...
    NERLoadModel=dict(
        ...
        args=dict(
            ...
            ner_model_weight='storage/output/220209_baseline_cvfold0_longformer/NERTrain/allenai-longformer-base-4096_valscore0.61816_ep2.pt',
            ner_model_args=dict(
                bert_model='allenai/longformer-base-4096',
                num_labels=15,
                freeze_bert=False,
