...
fold = 0
name = '220209_baseline+stance+lstm_cvfold{:d}_longformer'.format(fold)
...
conf = dict(
    ...
    NERLoadModel=dict(
        ...
        args=dict(
            ...
            stance_model_weight='storage/output/220203_stance_cvfold0_longformer/NERTrain/allenai-longformer-base-4096_valscore0.76341_ep0.pt',
