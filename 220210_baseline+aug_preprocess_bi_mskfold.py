...
name = '220210_baseline+aug_preprocess_bi_mskfold'
...
conf = dict(
    ...
    NERPreprocessKFold=dict(
        discourse_df_csv_path='storage/output/220210_aug_discourse_df_en-ru/train.csv',
        fold=0,
        bert_model="allenai/longformer-base-4096",
        args=dict(
            input='storage/output/220210_aug_discourse_df_en-ru/',
            ),
        num_jobs=1,
        max_len=1536,
        train_bs=4,
