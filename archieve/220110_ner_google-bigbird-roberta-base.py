...
conf = dict(
    base_dir='storage/output/220110_ner_google-bigbird-roberta-base/',

    slurm=dict(
        fname='slurm.cfg',
        pyscript='run_qa.py',
        name='220110_ner_google-bigbird-roberta-base',
        memory='32gb',
        ...
        ncore='1',
        ntasks='1',
        commands='python3 220110_ner_google-bigbird-roberta-base.py',
    ),
