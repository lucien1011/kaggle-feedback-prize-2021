...
fold = 0
name = '220125_baseline+cvfold{:d}_longformer'.format(fold)
...
conf = dict(
    ...
    NERLoadModel=dict(
        ...
        bert_model="allenai/longformer-base-4096",
        model_name='model',
        saved_model='storage/output/220125_baseline+cvfold0_longformer/NERTrain/allenai-longformer-base-4096_ep4.pt',
        ),
