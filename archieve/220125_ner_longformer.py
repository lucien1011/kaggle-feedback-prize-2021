...
conf = dict(
    base_dir='storage/output/220125_ner_longformer/',

    slurm=dict(
        fname='slurm.cfg',
        pyscript='run_qa.py',
        name='220125_ner_longformer',
        memory='32gb',
        ...
        ncore='1',
        ntasks='1',
        commands='python3 220125_ner_longformer.py',
    ),
    ...
    NERLoadModel=dict(
        ...
        bert_model="allenai/longformer-base-4096",
        model_name='model',
        saved_model='storage/output/220125_ner_longformer/NERTrain/allenai-longformer-base-4096_valscore1116.41472_ep0.pt',
        ),
