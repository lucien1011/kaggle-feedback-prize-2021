...
fold = 0
name = '220201_pairwise_cvfold{:d}_longformer'.format(fold)
...
conf = dict(
    ...
    PrepareData=dict(
        ...
        train_samples_path='storage/output/220201_pairwise_preprocess_mskfold/PreprocessKFold/train_samples_fold{:d}.p'.format(fold),
        valid_samples_path='storage/output/220201_pairwise_preprocess_mskfold/PreprocessKFold/valid_samples_fold{:d}.p'.format(fold),
