...
conf = dict(
    ...
    NERLoadModel=dict(
        ...
        args=dict(
            ...
            ner_model_weight='storage/output/220128_baseline+cvfold1_longformer/NERTrain/allenai-longformer-base-4096_valscore0.65414_ep5.pt',
            ner_model_args=dict(
                bert_model='allenai/longformer-base-4096',
                num_labels=15,
                freeze_bert=False,
            ...
            stance_model_weight='storage/output/220207_stance_cvfold1_longformer/NERTrain/allenai-longformer-base-4096_valscore0.39671_ep5.pt',
