...
import multitask as mod
from utils import read_attr_conf

fold = 0
name = '220209_multitask+softmax_cvfold{:d}_longformer'.format(fold)
...
conf = dict(
    ...
    NERLoadModel=dict(
        type='CustomModel',
        custom_model='MultiTaskNERModel',
        args=dict(
            bert_model="allenai/longformer-base-4096",
            num_labels=15,
            num_stance_labels=3,
...
pipelines = [
        ...
        #('NEREvaluateScoreVsThreshold',mod.EvaluateScoreVsThreshold()),
        ]
