...
class PrepareData(Module):
    ...
    def prepare(self,container,params):
        ...
        container.train_qa_df['types'] = container.train_qa_df['types'].apply(lambda x: eval(x))
        ...
        train_set = QADataset(container.train_qa_df,tokenizer,params['maxlen'],True,labels_to_ids,params['tokenizer_args'])
