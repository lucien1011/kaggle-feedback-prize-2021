...
def evaluate_accuracy_f1_one_step(labels,logits,num_labels):
    ...
    return accuracy_score(labels.cpu().numpy(), predictions.cpu().numpy()),f1_score(labels.cpu().numpy(), predictions.cpu().numpy(),average='macro')
...
class Train(Module):
    ...
    def fit(self,container,params):
        ...
        for epoch in range(params['epochs']):
            ...
            tqdm.write(f"Training f1 epoch: {tr_f1}") 
